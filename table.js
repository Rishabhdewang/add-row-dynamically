...
function addHtmlTableRow(){
    ...
    cell2.innerHTML = `<input type="text" id="com" name="company" > <p id="comerr" style = "color: red"></p>`;
    cell3.innerHTML = `<input type="number" id="phno" name="phoneno" > <p id="pherr" style = "color: red"></p>`;
    cell4.innerHTML = 
...
function validate(){
    ...
    com.addEventListener('change', function () {
        if(com.value == "") {
            ...
            if(err == ""){
                ...
                document.getElementById("com").setAttribute("style", "border : 1.5px solid red");
            ...
            document.getElementById("com").removeAttribute('style');
    ...
    phno.addEventListener('change', function () {
        var regex = /^[6-9]\d{9}$/;
        if(regex.test(phno.value) == false) {
            ...
            // removeError("phno", "");
            document.getElementById("phno").removeAttribute('style');
    ...
    coun.addEventListener('change', function () {
        if(coun.value == "Select") {
            ...
            // removeError("coun");
            document.getElementById("coun").removeAttribute('style');
...
//     // Defining error variables with a default value
    ...
    if(s3 == "") {
        ...
        // console.log(err)
        if(err == ""){
            document.getElementById("phno").setAttribute("style", "border : 1.5px solid red");
        document.getElementById(`pherr`).setAttribute("style", 'padding : 2px; margin : 0px; color :red; font-size : small;  ')
    ...
    if(s4 == "Select") {
        ...
        // console.log(err)
        if(err == ""){
            document.getElementById("coun").setAttribute("style", "border : 1.5px solid red");
        document.getElementById(`counerr`).setAttribute("style", 'padding : 2px; margin : 0px; color :red; font-size : small;  ')
        document.getElementById(`counerr`).innerHTML = "Please select country";
        } // printError("coun", "Please select your country");
    } else {
    ...
    if(s5 == "") {
        ...
        // console.log(err)
        if(err == ""){
            document.getElementById("add").setAttribute("style", "border : 1.5px solid red");
        document.getElementById(`adderr`).setAttribute("style", 'padding : 2px; margin : 0px; color :red; font-size : small;  ')
        document.getElementById(`adderr`).innerHTML = "Please enter your address";
        }
    } else{
...
function Edit(row){
    ...
    i.cells[1].innerHTML = `<input type="text" id="com" value="${s2}" name="company" > <p id="comerr" style = "color: red"></p>`;
    i.cells[2].innerHTML = `<input type="number" id="phno" value="${s3}" name="phoneno"  > <p id="pherr" style = "color: red"></p>`;
